...
Along with the consistent expansion of research and development, Toan Phat Irradiation has applied the combination of all three technologies in various ways into irradiation products in order to meet the needs of its customers and to guarantee its firm position in the market.`,
    subDesc: [
      ...
      },
      {
        ...
        eventKey: 'e-beam',
        imgSrc: ebeamIMG,
        desc: `The irradiation process by E-Beam technology uses ionizing radiation, which is high-energy Electrons. The Electrons generated by the Electron Gun are accelerated by high frequency waves through the high frequency energy resonance structure amplified from the power source. Electrons have a negative charge, a small mass, and high energy. Therefore, they easily interact with atoms and molecules in food though primary and secondary effects and cause very fast reactions on molecules or microorganisms.`,
      ...
      },
      {
        ...
        eventKey: 'x-ray',
        imgSrc: xrayIMG,
        desc: `The X-ray irradiation is a method that has been developed by using electron beams to irradiate. Electrons are generated in the device with energy from between 5MeV and 7.5MeV. Electrons interact with the Tantalum plate to produce X-Rays in what is known as Bremsstrahlung (braking) radiation.`,
