    ...
    return(
        <>
            ...
            <div className="flex flex-col max-w-7xl w-full items-center justify-center m-auto h-auto mt-4">
                <h1 data-aos='fade-up' className="text-3xl lg:text-5xl font-semiBold lg:font-bold w-full text-center mt-12 text-green-800">
                ...
                <div className="grid lg:grid-cols-2 gap-24 mt-12">
                    {contactInfoLocale.directContact.sub.map((item, index) => (
                        <div key={index} className="flex flex-col items-start justify-between p-1">
                            <h1 data-aos='fade-up' className="text-xl lg:text-2xl font-semiBold text-left text-green-800 mt-1 p-1">
                                {item.title}
                            </h1>
                            <p data-aos='fade-up' className="text-md lg:text-xl text-left mt-1 p-1">
                                {item.desc}
                            </p>
                            <div data-aos='fade-up' className="flex flex-row items-center justify-center">                                
                            ...
                            <div data-aos='fade-up' className="flex flex-row w-full items-start justify-center pr-11 pl-0">                                
