    ...
    <>
      <div className={styles['container']}>
        ...
        <div className={styles['member-content']}>
          ...
          <div className={styles['member-content__maindesc']}>{maindesc}</div>
          <div
            className={styles['member-content__content']}
            ref={refMemberContent}
          >
            <div className={styles['member-content__content__title']} ref={refMemberContent}>{title1}</div>
            <NumberAndDesc number={1} desc={desc1} />
            <div className={styles['member-content__content__title']} ref={refMemberContent}>{title2}</div>
            <NumberAndDesc number={2} desc={desc2} />
            <div className={styles['member-content__content__title']} ref={refMemberContent}>{title3}</div>
