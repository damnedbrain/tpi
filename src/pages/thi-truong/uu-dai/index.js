...
export default function ThiTruongPage() {
    ...
    return (
        <>
            <Head>
                <title>
                    {locale === "en-US" ? "TOAN PHAT - Promotion News" : "TOAN PHAT - Promotion News"}
                </title>
                <meta name='title' content={locale === "en-US" ? "TOAN PHAT - Promotion News" : "TOAN PHAT - Promotion News"}/>
                <meta name='description' content={locale === "en-US" ? "TOAN PHAT - Promotion News" : "TOAN PHAT - Promotion News"}/>
                {/* <meta name='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta itemProp='name' content={locale === "en-US" ? "TOAN PHAT - Promotion News" : "TOAN PHAT - Promotion News"}/>
                <meta itemProp='description' content={locale === "en-US" ? "TOAN PHAT - Promotion News" : "TOAN PHAT - Promotion News"}/>
                {/* <meta itemProp='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta property='og:url' content={'toanphatgroup.com/thi-truong/uu-dai/'} />
                <meta property='og:type' content='website' />
                <meta property='og:title' content={locale === "en-US" ? "TOAN PHAT - Promotion News" : "TOAN PHAT - Promotion News"}/>
                <meta property='og:description' content={locale === "en-US" ? "TOAN PHAT - Promotion News" : "TOAN PHAT - Promotion News"}/>
