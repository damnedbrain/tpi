...
export default function ThiTruongPromoPage({ entries, pageCount }) {
    ...
    return (
        <>
            <Head>
                <title>{locale === 'en-US' ? 'TOAN PHAT - Promotion' : 'TOAN PHAT - Ưu đãi'}</title>
            </Head>
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <Pagination currentPage={1} pageCount={pageCount} basePageURL="uu-dai" />
            </div>
        </>
    );
}
