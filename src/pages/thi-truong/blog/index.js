...
export default function ThiTruongPage() {
    ...
    return (
        <>
            <Head>
                <title>
                    {locale === "en-US" ? "TOAN PHAT - Blog" : "TOAN PHAT - Blog"}
                </title>
                <meta name='title' content={locale === "en-US" ? "TOAN PHAT - Blog" : "TOAN PHAT - Blog"}/>
                <meta name='description' content={locale === "en-US" ? "TOAN PHAT - Blog" : "TOAN PHAT - Blog"}/>
                {/* <meta name='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta itemProp='name' content={locale === "en-US" ? "TOAN PHAT - Blog" : "TOAN PHAT - Blog"}/>
                <meta itemProp='description' content={locale === "en-US" ? "TOAN PHAT - Blog" : "TOAN PHAT - Blog"}/>
                {/* <meta itemProp='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta property='og:url' content={'toanphatgroup.com/thi-truong/blog/'} />
                <meta property='og:type' content='website' />
                <meta property='og:title' content={locale === "en-US" ? "TOAN PHAT - Blog" : "TOAN PHAT - Blog"}/>
                <meta property='og:description' content={locale === "en-US" ? "TOAN PHAT - Blog" : "TOAN PHAT - Blog"}/>
            ...
            <div className="flex flex-col max-w-7xl h-auto m-auto p-1 items-center justify-center">
                <h1 className="text-4xl font-extrabold col-span-3 row-span-1 mt-4 mb-2">
                    {locale === "en-US" ? "Blog" : "Toàn Phát Blog"}
                </h1>
