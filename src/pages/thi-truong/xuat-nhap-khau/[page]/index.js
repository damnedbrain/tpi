...
export default function ThiTruongPage() {
    ...
    return (
        <>
            <Head>
                <title>
                    {locale === "en-US" ? "TOAN PHAT - Logistics News" : "TOAN PHAT - Logistics News"}
                </title>
                <meta name='title' content={locale === "en-US" ? "TOAN PHAT - Logistics News" : "TOAN PHAT - Logistics News"}/>
                <meta name='description' content={locale === "en-US" ? "TOAN PHAT - Logistics News" : "TOAN PHAT - Logistics News"}/>
                {/* <meta name='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta itemProp='name' content={locale === "en-US" ? "TOAN PHAT - Logistics News" : "TOAN PHAT - Logistics News"}/>
                <meta itemProp='description' content={locale === "en-US" ? "TOAN PHAT - Logistics News" : "TOAN PHAT - Logistics News"}/>
                {/* <meta itemProp='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta property='og:url' content={'toanphatgroup.com/thi-truong/xuat-nhap-khau/'} />
                <meta property='og:type' content='website' />
                <meta property='og:title' content={locale === "en-US" ? "TOAN PHAT - Logistics News" : "TOAN PHAT - Logistics News"}/>
                <meta property='og:description' content={locale === "en-US" ? "TOAN PHAT - Logistics News" : "TOAN PHAT - Logistics News"}/>
            ...
            <div className="flex flex-col max-w-7xl h-auto m-auto p-1 items-center justify-center">
                <h1 className="text-4xl font-extrabold col-span-3 row-span-1 mt-4 mb-2">
                    {locale === "en-US" ? "Logistics" : "Xuất Nhập Khẩu"}
                </h1>
                ...
                <div className='flex flex-row'>
                    <div className='flex flex-col lg:w-4/5 items-center justify-start mt-8'>                        
                        <div className="flex flex-col m-0">
                            ...
                            <Pagination currentPage={pageIndex + 1} pageCount={pageCount} basePageURL="xuat-nhap-khau" />
                        </div>
                    </div>
