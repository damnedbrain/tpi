...
export default function ThiTruongPage() {
    ...
    return (
        <>
            <Head>
                <title>
                    {locale === "en-US" ? "TOAN PHAT - Industrial Cold Storage News" : "TOAN PHAT - Industrial Cold Storage News"}
                </title>
                <meta name='title' content={locale === "en-US" ? "TOAN PHAT - Industrial Cold Storage News" : "TOAN PHAT - Industrial Cold Storage News"}/>
                <meta name='description' content={locale === "en-US" ? "TOAN PHAT - Industrial Cold Storage News" : "TOAN PHAT - Industrial Cold Storage News"}/>
                {/* <meta name='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta itemProp='name' content={locale === "en-US" ? "TOAN PHAT - Industrial Cold Storage News" : "TOAN PHAT - Industrial Cold Storage News"}/>
                <meta itemProp='description' content={locale === "en-US" ? "TOAN PHAT - Industrial Cold Storage News" : "TOAN PHAT - Industrial Cold Storage News"}/>
                {/* <meta itemProp='image' content={`https:${entry.fields.thumbImage.fields.file.url}`} /> */}

                <meta property='og:url' content={'toanphatgroup.com/thi-truong/kho-lanh/'} />
                <meta property='og:type' content='website' />
                <meta property='og:title' content={locale === "en-US" ? "TOAN PHAT - Industrial Cold Storage News" : "TOAN PHAT - Industrial Cold Storage News"}/>
                <meta property='og:description' content={locale === "en-US" ? "TOAN PHAT - Industrial Cold Storage News" : "TOAN PHAT - Industrial Cold Storage News"}/>
                ...
                <div className='flex flex-row'>
                    <div className='flex flex-col lg:w-4/5 items-center justify-start mt-8'>                        
                        <div className="flex flex-col m-0">
                            ...
                            <Pagination currentPage={1} pageCount={pageCount} basePageURL="kho-lanh" />
                        </div>
                    </div>
