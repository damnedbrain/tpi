...
export default function ThiTruongNewsPage({ entries, pageCount }) {
    ...
    return (
        <>
            <Head>
                <title>{locale === 'en-US' ? 'TOAN PHAT - News' : 'TOAN PHAT - Thị trường'}</title>
            </Head>
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <Pagination currentPage={1} pageCount={pageCount} basePageURL="thi-truong" />
            </div>
        </>
    );
}
